/* 게임 모드 → 페이즈 프로세스 DBML. 사전에 정리된 기획 문서가 없어, GameMode.Json /
   GameMode_Group.Json / PhaseProcess.Json 원본을 직접 분석해서 작성했습니다.
...
Ref: GameMode.Group > GameMode_Group.Name
Ref: GameMode.StartPhaseProcess_ID > PhaseProcess.ID
Ref: PhaseProcess.NextPhase_ID > PhaseProcess.ID
Ref: GameMode.ModeName_StringID > String.Key
Ref: GameMode.Rule_StringID > String.Key
Ref: GameMode_Group.Name_StringID > String.Key
`;
